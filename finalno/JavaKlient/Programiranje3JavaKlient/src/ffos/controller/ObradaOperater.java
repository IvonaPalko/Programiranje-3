...
public class ObradaOperater {
    ...
    private static final String PUTANJA_API = "http://it.ffos.hr/P320182019/ipalko/finalno/api/";
    ...
    public List<Operater> getOperateri() {
        return gson.fromJson(getAPI("automobili", null, "GET"), new TypeToken<List<Operater>>() {
        }.getType());
    }
    ...
    public Operater getOperater(int sifra) {
        return gson.fromJson(getAPI(("automobili/" + sifra), null, "GET"),Operater.class);
    }

    public boolean dodajOperatera(Operater o) {
        return getAPI("novi", o, "POST").equals("OK");
    }

    public boolean promijeniOperatera(Operater o) {
        return getAPI("update", o, "POST").equals("OK");
    }

    public boolean obrisiOperatera(Operater o) {
         return getAPI("obrisi", o, "POST").equals("OK");
    }
